...
function getPagination(page: number | string = 1, limit: number | string = 20) {
...
function getTimeRangeFilter(options: { timeRange?: string; timeFrom?: string; timeTo?: string }) {
...
export { queryFilter, getPagination, getTimeRangeFilter };
